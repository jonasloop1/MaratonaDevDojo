...
public class LocaleTest01 {
    public static void main(String[] args) {
        ...
        System.out.println("\nDe acordo com a linguagem do sistema operacional:\n");
        ...
        System.out.println("\nTraduzindo um lingua na outra:\n");
        System.out.println(localeJapao.getDisplayLanguage(localeIndia));
        System.out.println(localeHolanda.getDisplayLanguage(localeJapao));
    }
}
